...
class DatalogColorSettingsPage : ColorSettingsPage {
    ...
    private val demoCode by lazy {
        ...
        val text = StreamUtil.convertSeparators(StreamUtil.readText(stream, "UTF-8"))
    ...
    private fun annotateText(text: String): String? {
        val anyProject = ProjectManager.getInstance().openProjects.first() ?: return null
        val psiFile = DatalogPsiFactory(anyProject).createFile(text)
